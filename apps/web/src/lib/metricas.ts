...
const UMBRALES: Record<Metric, Umbrales> = {
  ...
  // Mientras hay búsqueda activa cambian por hora: una cifra de ayer puede mandar un
  // equipo a un sitio ya despejado.
  people_trapped: RAPIDO,
  people_rescued: RAPIDO,
  buildings_collapsed: LENTO,
  buildings_partially_collapsed: LENTO,
  buildings_damaged: LENTO,
  health_facilities_affected: LENTO,
  schools_affected: LENTO,
};
